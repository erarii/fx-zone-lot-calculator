...
# --- 計算ロジック ---
def calc_positions(pair, direction, division, weights, avg_price, max_loss, stop, upper, lower, market_price=None):
...
# ゾーン上限下限入力
upper = st.number_input("ゾーン上限", value=150.0 if "JPY" in pair else 1.0)
lower = st.number_input("ゾーン下限", value=149.5 if "JPY" in pair else 0.995)
